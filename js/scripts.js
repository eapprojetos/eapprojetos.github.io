...
(function ($) {
    ...
    function rsubmitForm() {
        ...
        $.ajax({
            type: "POST",
            url: "http://eapprojetos.com.br:5000/request/service",
            dataType: "json",
            ...
            error: function (request, status, error) {
                rformError();
                rsubmitMSG(false, "Error ao enviar, por favor, tentar contato por WhatsApp!");
            }
    ...
    function rformSuccess() {
        $("#requestForm")[0].reset();
        rsubmitMSG(true, "Enviado com Sucesso!");
